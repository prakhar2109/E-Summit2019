    ...
    render() {
        return (
            ...
            <div className="land_screen2">
                ...
                <p className = "p">Indian Institute of Technology, Roorkee has a history of creating leaders and pioneers of
...
thriving long-term partnership.</p>
                <Header title="THEME: BUILDING FOR THE BILLION"/>    
                <p className = "p">Several business ventures work out and end up as successes and unfortunately,
