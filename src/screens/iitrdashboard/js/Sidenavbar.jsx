        ...
        <div id="container">
          <div id="leftPane">
            ...
            <div id="optionsToggle">
              <span>
              <Link to="/iitrdashboard/task" className={(this.state.activeState === "task") ? "linkEventson" : null} onClick={() => {
                                            this.setActive("task");
                                        }}>
              TASKS
              </Link>
              ...
              <span>
              <Link to="/iitrdashboard/leader" className={(this.state.activeState === "leaderboard") ? "linkEventson" : null} onClick={() => {
              ...
              <span>
              <Link to="/iitrdashboard/offers" className={(this.state.activeState === "offers") ? "linkEventson" : null} onClick={() => {
              ...
              <span>
              <Link to="/iitrdashboard/invite" className={(this.state.activeState === "invite") ? "linkEventson" : null} onClick={() => {
              ...
              <span>
              <Link to="/iitrdashboard/contigent" className={(this.state.activeState === "contigent") ? "linkEventson" : null} onClick={() => {
