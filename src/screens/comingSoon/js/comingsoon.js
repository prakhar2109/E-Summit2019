...
class ComingSoon extends Component {
  ...
  validate = () => {
    ...
    if (
            this.state.register_phone.length > 10 ||
            this.state.register_phone.length < 10 ||
            !phoneValidation.test(this.state.register_phone)
        ) {
      isError = true
        ...
        <div className='row'>
          <div className='col-sm-12 col-md-7' id='left'>
            ...
            <div className='contacts'>
              ...
              <p>
                                Rachit Garg:9992929203&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Vedant Kumar:7909060873
                            </p>
            </div>
          </div>
            ...
            <div className='form' id='test-form'>
              ...
              <form name='submit-to-google-sheet'>
                ...
                <select
                  ...
                  name='Profession'
                  id='registerDropDown'
                  value={this.state.register_profession}
                  onChange={event => {
                    this.setState({
                ...
                <input
                  ...
                  required
                                />
                <button onClick={this.handleClick} className='registerBtn' id='submitBtn'>
                                    SUBMIT
                                </button>
              </form>
            </div>
