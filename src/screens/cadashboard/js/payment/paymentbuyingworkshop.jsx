...
export default class Payment extends Component{
    constructor(){
        ...
        this.state={
            ...
            couponSelected:'',
            totalAmount:0,
            //workshop details for new workshops to buy
            noOfWorkshopsNew:7,
            workshopsNew:[
                {
                    'name':'workshop1',
            ...
            registrationFeePayed:100,
            accomodationFeePayed:1000,
            datePayed:'12/12/12',
            totAmtPayed:1860,
            subTotal:100,
            visibleAccomodationFeePayed:1000,
            couponDiscountPercentPayed:60,
            couponDiscountPayed:700,
            //workshop details for which payment is already done
            noOfWorkshopsNew:2,
            workshopsNew:[
                {
                    'name':'workshop1',
    ...
    render(){
        let {isCouponValid,isPayed,registrationFee,visibleAccomodationFee,noOfWorkshopsNew,noOfWorkshopsBought,workshopsBought,workshopsNew,couponDiscountPayed,totAmtPayedW,datePayedW,subTotal,totalAmount} = this.state
        ...
        totalAmount = 500*noOfWorkshopsNew
           
        let {registrationFeePayed,visibleAccomodationFeePayed,discountAvailedPercentPayed,couponDiscount,couponDiscountPercent,couponDiscountPercentPayed,datePayed,totAmtPayed} = this.state
             ...
             <div className="capaymentwv-paymentinfo">
                ...
                <span className="capaymentwv-span">Payment Status</span> : Pending
                    ...
                    <div className='capaymentwv-workshop-parent'>
                        ...
                        <Payments workshops={workshopsBought} noOfWorkshops={noOfWorkshopsBought}/>
                    </div>          
...
<path d="M20.4258 0C9.37716 0 0.425781 8.95138 0.425781 20C0.425781 31.0486 9.37716 40 20.4258 40C31.4744 40 40.4258 31.0486 40.4258 20C40.4141 8.95138 31.4627 0 20.4258 0ZM20.4258 36.3679C11.3807 36.3679 4.04617 29.0334 4.04617 19.9883C4.04617 10.9432 11.3807 3.60867 20.4258 3.60867C29.4709 3.62039 36.7937 10.9432 36.8054 19.9883C36.7937 29.0451 29.4709 36.3679 20.4258 36.3679Z" fill="#70BF48"/>
  ...
  <div className="capaymentwv-registrationfee">
                 ...
                 <div className="capaymentwv-spaceaboutcolon">Coupon Discount </div> :<div className="capaymentwv-space"></div>Rs&nbsp;{couponDiscount}<div className='capayment-earlybirddiscount'>({couponDiscountPercent} % Off)</div>
                 </div>
                 {/* <div className="capaymentwv-horizontalline"></div> */}
                 ...
                 <div className='capaymentwv-workshop-parent'>
                        ...
                        <Payments workshops={workshopsNew} noOfWorkshops={noOfWorkshopsNew}/>
                    </div>
                    <div className="capaymentwv-horizontalline"></div>    
                    <div className='capaymentwv-totlamt'>
                        <div className="capaymentwv-spaceaboutcolon-total">Total Amount</div> :<div className="capaymentwv-space"></div>Rs&nbsp;{totalAmount}
...
<path d="M20.4258 0C9.37716 0 0.425781 8.95138 0.425781 20C0.425781 31.0486 9.37716 40 20.4258 40C31.4744 40 40.4258 31.0486 40.4258 20C40.4141 8.95138 31.4627 0 20.4258 0ZM20.4258 36.3679C11.3807 36.3679 4.04617 29.0334 4.04617 19.9883C4.04617 10.9432 11.3807 3.60867 20.4258 3.60867C29.4709 3.62039 36.7937 10.9432 36.8054 19.9883C36.7937 29.0451 29.4709 36.3679 20.4258 36.3679Z" fill="#70BF48"/>
                ...
                <div className='capayment-billingdetails-secondrow'>
                 ...
                 <div className='capaymentwv-workshop-parent'>
                        ...
                        <Payments noOfWorkshops={noOfWorkshopsNew} workshops={workshopsNew} />
                    </div>
                    <div className="capaymentwv-horizontalline"></div>    
                    <div className='capaymentwv-totlamt'>
...
<path d="M20.4258 0C9.37716 0 0.425781 8.95138 0.425781 20C0.425781 31.0486 9.37716 40 20.4258 40C31.4744 40 40.4258 31.0486 40.4258 20C40.4141 8.95138 31.4627 0 20.4258 0ZM20.4258 36.3679C11.3807 36.3679 4.04617 29.0334 4.04617 19.9883C4.04617 10.9432 11.3807 3.60867 20.4258 3.60867C29.4709 3.62039 36.7937 10.9432 36.8054 19.9883C36.7937 29.0451 29.4709 36.3679 20.4258 36.3679Z" fill="#70BF48"/>
  ...
  <div className="capaymentwv-registrationfee">
                 ...
                 <div className='capaymentwv-workshop-parent'>
                        ...
                        <Payments noOfWorkshops={noOfWorkshopsBought} workshops={workshopsBought}/>
                    </div>
                    <div className="capaymentwv-horizontalline"></div>    
                    <div className='capaymentwv-totlamt'>
                        <div className="capaymentwv-spaceaboutcolon-total">Total Amount</div> :<div className="capaymentwv-space"></div>Rs&nbsp;{totalAmount}
