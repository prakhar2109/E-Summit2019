...
import './../../css/payment/paymentwithworkshop.css'
...
export default class Payment extends Component{
    constructor(){
        ...
        this.state={
            ...
            datePayed:'12/12/12',
            noOfWorkshopsPayed:2,
            couponDiscountPayed:87,
            couponDiscountPercentPayed:66,
            workshopsPayed:[
                {
                    'name':'workshop1',
                    'cost':550
    ...
    render(){
        let {isCouponValid,isPayed,coupDiscountPayed,registrationFee,workshopsNotPayed,workshopsPayed,noOfWorkshopsPayed,noOfWorkshopsNotPayed,couponDiscount,couponDiscountPayed,totalamtPayed,visibleAccomodationFee,discountAvailedPercent,couponDiscountPercent,subTotal,totalAmount} = this.state
        ...
        subTotal = -couponDiscount + visibleAccomodationFee + registrationFee
        totalAmount =  subTotal + 500*noOfWorkshopsNotPayed
        ...
        <div className="capaymentwv-parent">
             ...
             <div className="capaymentwv-paymentinfo">
                ...
                <span className="capaymentwv-span">Payment Status</span> : Pending
                 ...
                 <div className="capaymentwv-spaceaboutcolon">Coupon Discount<button id="capaymentwv-couponapply" className="capaymentwv-couponapply" onClick={e=>{this.toggleCoupon(e)}}>APPLY</button> </div> :<dicouponDiscountPercentv className="capaymentwv-space"></dicouponDiscountPercentv><div className='capayment-viewbillingdetails-coupondiscount'>-Rs {couponDiscount}</div><div className='capayment-earlybirddiscount'>({couponDiscountPercent} % Off)</div>
                 {isCouponValid?(
                     
                     <Modal
                     className="capaymentwv-couponmodal"
                     title="APPLY COUPON"
                     visible={this.state.isModalVisible}
                     onOk={this.handleOk}
                     onCancel={this.handleCancel}
                     >
         <div className="capaymentwv-modalparent">
                     <div className="capaymentwv-modalheader">
                     Enter Coupon Code
                     </div>
                     <input className="capaymentwv-modalinputcode" value={this.state.couponcode} onChange={e=>{
                         this.setState({
                             couponcode:e.target.value,
                         })
                     }} type="text"/>
                     <div className="capaymentwv-modalmiddlerow">
                         <hr className="capaymentwv-modalline" /> OR <hr className="capaymentwv-modalline" />
                     </div>
                     <div className="capaymentwv-modallastrow">
                         <div className="capaymentwv-modallastrowheader">Choose a valid coupon</div>
                         <div className="capaymentwv-modalcouponlist1">
                             <Coupon />
                         </div>
                     </div>
                     </div>
                    ...
                    <div className="capaymentwv-modalparent">
                        ...
                        <div className="capaymentwv-modallastrow">
                            <div className="capaymentwv-modallastrowheader1">Coupons not Valid on this payment</div>
                            <div className="capaymentwv-modalcouponlist">
                                <Coupon />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="capaymentwv-spaceaboutcolon1">Sub Total Amount</div>:<div className="capaymentwv-space"></div>Rs&nbsp;{subTotal}
                    
                    </div>
                    {/* <div className="capaymentwv-line2"></div> */}
  
                    <div className='capaymentwv-hortizontalline2'></div>
                    <div className='capaymentwv-workshop-parent'>
                        <div className='capaymentwv-workshop-header'>
                            Workshops
                        </div>
                        <Payments workshops={workshopsNotPayed} noOfWorkshops={noOfWorkshopsNotPayed} />
                    </div>          
...
<path d="M20.4258 0C9.37716 0 0.425781 8.95138 0.425781 20C0.425781 31.0486 9.37716 40 20.4258 40C31.4744 40 40.4258 31.0486 40.4258 20C40.4141 8.95138 31.4627 0 20.4258 0ZM20.4258 36.3679C11.3807 36.3679 4.04617 29.0334 4.04617 19.9883C4.04617 10.9432 11.3807 3.60867 20.4258 3.60867C29.4709 3.62039 36.7937 10.9432 36.8054 19.9883C36.7937 29.0451 29.4709 36.3679 20.4258 36.3679Z" fill="#70BF48"/>
  ...
  <div className="capaymentwv-registrationfee">
                     <div className="capaymentwv-spaceaboutcolon">Registration Fee</div> :<div className="capaymentwv-space"></div>Rs&nbsp;{registrationFeePayed}<div className='capaymentwv-earlybirddiscount'>(Early Bird Discount)</div>
                 </div>
                 <div className="capaymentwv-accomodationfee">
                 <div className="capaymentwv-spaceaboutcolon">Accomodation Fee  </div> :<div className="capaymentwv-space"></div>Rs&nbsp;{visibleAccomodationFeePayed}
                 </div>
                 
                 <div className="capaymentwv-discountcoupon">
                 <div className="capaymentwv-spaceaboutcolon">Coupon Discount </div> :<div className="capaymentwv-space"></div>Rs&nbsp;{couponDiscountPayed}<div className='capayment-earlybirddiscount'>({couponDiscountPercentPayed} % Off)</div>
                 </div>
                 {/* <div className="capaymentwv-horizontalline"></div> */}
                 <div className="capaymentwv-totalamt">
                 <div className="capaymentwv-spaceaboutcolon12">Sub Total Amount</div>:<div className="capaymentwv-space"></div>Rs&nbsp;{subTotal}
