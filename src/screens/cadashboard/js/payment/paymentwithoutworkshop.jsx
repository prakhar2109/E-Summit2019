...
export default class Payment extends Component{
    constructor(){
        ...
        this.state={
            ...
            registrationFee:null,//data if payment not done
          ...
          axios
            ...
            .then(res => {
                ...
                this.setState({ 
                    ...
                    visibleAccomodationFee:res.data.payment.payment_details.accommodation_fees,
                    accomodationFee:res.data.payment.payment_details.accommodation_fees,
                ...
                this.setState({ 
                    isPayed:true,
                    registrationFeePayed:res.data.payment.registration_fee,
                    visibleAccomodationFeePayed:res.data.payment.accommodation_fee,
                    accomodationFee:res.data.payment.accommodation_fee,
                    totAmtPayed:res.data.payment.total_amount,
                    });    
    ...
    onPay = e =>{
        // e.preventDefault()
        let token = localStorage.getItem("user_token");
        let URL = 'https://dev.esummit.in'
        if (token !== undefined) {
          
                window.location.assign(BASE_URL+"/v1/pay/now/")
                let ta= window.location.search
                console.log(ta)
                axios
                .get(URL + "/v1/pay/complete/"+ta, {
                  headers: {
                    Authorization: `Token ${token}`,
                  },
                })
                .then(res => {
                    let datePayed = res.data.data.date_created(0,10)
                    let dataPayment = res.data.data.filter(x=>x.confirmed===true)
                    let totAmtPayed = dataPayment.amount_paid
    ...
    render()
    {   
        let {isCouponValid,isPayed,couponDiscount,registrationFee,visibleAccomodationFee,totalFee,discountAvailedPercent,couponDiscountPercent,totAmtPayed,datePayed} = this.state
        ...
        let {registrationFeePayed,couponDiscountPayed,visibleAccomodationFeePayed,discountAvailedPercentPayed,couponDiscountPercentPayed} = this.state
                 ...
                 <div className="capayment-paymentinfo">
                    ...
                    <span className="capayment-span">Payment Status</span> : Pending
                     ...
                     <div className="capayment-registrationfee">
                         <div className="capayment-spaceaboutcolon">Registration Fee</div> :<div className="capayment-space"></div>Rs {registrationFee}<div className='capayment-earlybirddiscount'>(Early Bird Discount)</div>
                     </div>
                     ...
                     <div className="capayment-spaceaboutcolon">Coupon Discount </div> :<div className="capayment-space"></div><div className='capayment-viewbillingdetails-coupondiscount'>- Rs {couponDiscount}</div><div className='capayment-earlybirddiscount'>({couponDiscountPercent} % Off)</div>
...
<path d="M20.4258 0C9.37716 0 0.425781 8.95138 0.425781 20C0.425781 31.0486 9.37716 40 20.4258 40C31.4744 40 40.4258 31.0486 40.4258 20C40.4141 8.95138 31.4627 0 20.4258 0ZM20.4258 36.3679C11.3807 36.3679 4.04617 29.0334 4.04617 19.9883C4.04617 10.9432 11.3807 3.60867 20.4258 3.60867C29.4709 3.62039 36.7937 10.9432 36.8054 19.9883C36.7937 29.0451 29.4709 36.3679 20.4258 36.3679Z" fill="#70BF48"/>
      ...
      <div className="capayment-registrationfee">
                     ...
                     <div className="capayment-spaceaboutcolon">Registration Fee</div> :<div className="capayment-space"></div>Rs {registrationFeePayed}<div className='capayment-earlybirddiscount'>(Early Bird Discount)</div>
                     </div>
                     <div className="capayment-accomodationfee">
                     <div className="capayment-spaceaboutcolon">Accomodation Fee  </div> :<div className="capayment-space"></div>Rs {visibleAccomodationFeePayed}
                     </div>
                     {/* <div className="capayment-discountavailed">
                     ...
                     <div className="capayment-discountcoupon">
                     <div className="capayment-spaceaboutcolon">Coupon Discount </div> :<div className="capayment-space"></div><div className='capayment-viewbillingdetails-coupondiscount'>- Rs {couponDiscountPayed}</div><div className='capayment-earlybirddiscount'>({couponDiscountPercentPayed} % Off)</div>
                     </div>
                     <div className="capayment-horizontalline"></div>
                     <div className="capayment-totalamt">
